<script>
    import { newsfeed, user, menu, setting, help, display, keyboard } from '../../stores/MainStores';
...
<div class="menu">
    ...
    <button class="button" on:click={settingBtn}>
        <div class="circle">
            <div class="icon" style="background-image: url(/images/util3.png); background-position: 0px -394px;"></div>
        </div>
    ...
    <button class="button" on:click={helpBtn}>
        <div class="circle">
            <div class="icon" style="background-image: url(/images/util4.png); background-position: 0px -322px;"></div>
        </div>
    ...
    <button class="button" on:click={displayBtn}>
        <div class="circle">
            <div class="icon" style="background-image: url(/images/util5.png); background-position: 0px -513px;"></div>
        </div>
    ...
    <div class="button">
        <div class="circle">
            <div class="icon" style="background-image: url(/images/util4.png); background-position: 0px -175px;"></div>
        </div>
        <div class="text">Give feedback</div>
    </div>
    <button on:click={logout} class="button">
        <div class="circle">
            <div class="icon" style="background-image: url(/images/util6.png); background-position: 0px -179px;"></div>
        </div>
    ...
    <div class="setting">
        <div class="row">
            <button on:click={backBtn} class="back">
                <div class="back-icon" style="background-position: -146px -99px;"></div>
            </button>
        ...
        <div class="button">
            <div class="circle">
                <div class="icon" style="background-image: url(/images/util4.png); background-position: 0px -280px;"></div>
            </div>
            <div class="text">Privacy Checkup</div>
        </div>
        <div class="button">
            <div class="circle">
                <div class="icon" style="background-image: url(/images/util6.png); background-position: 0px -263px;"></div>
            </div>
            <div class="text">Privacy Center</div>
        </div>
        <div class="button">
            <div class="circle">
                <div class="icon" style="background-image: url(/images/util8.png); background-position: 0px -796px;"></div>
            </div>
            <div class="text">Activity log</div>
        </div>
        <div class="button">
            <div class="circle">
                <div class="icon" style="background-image: url(/images/util4.png); background-position: 0px -196px;"></div>
            </div>
            <div class="text">Feed</div>
        </div>
        <div class="button">
            <div class="circle">
                <div class="icon" style="background-image: url(/images/util8.png); background-position: 0px -733px;"></div>
            </div>
...
{#if $help}
    <div class="help">
        ...
        <div class="button">
            <div class="circle">
                <div class="icon" style="background-image: url(/images/util8.png);     background-position: 0px -586px;"></div>
            </div>
            <div class="text">Support Inbox</div>
        </div>
        <div class="button">
            <div class="circle">
                <div class="icon" style="background-image: url(/images/util6.png); background-position: 0px -284px;"></div>
            </div>
...
{#if $display}
    <div class="display">
            ...
            <div class="column">
                ...
                <label for="dAutomatic" class="row-alt">
                    <div class="column">
                        ...
                        <label class="another-text" for="dAutomatic">We'll automatically adjust the display based on<br />
        ...
        <div class="compact">
            <div class="circle">
                <div class="icon" style="background-image: url(/images/util4.png); background-position: 0px -406px;"></div>
            </div>
            <div class="column">
        ...
        <button class="button" on:click={keyboardBtn}>
            <div class="circle">
                <div class="icon" style="background-image: url(/images/util4.png); background-position: 0px -238px;"></div>
            </div>
...
{#if $keyboard}
    <div class="keyboard">
        ...
        <div class="short">
            <div class="circle">
                <div class="icon" style="background-image: url(/images/util4.png); background-position: 0px -364px;"></div>
            </div>
            <div class="column">
